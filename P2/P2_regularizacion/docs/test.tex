...
\noindent{Modelo usado: \textbf{Minimos Cuadrados Ordinarios} (regresión lineal sin regularización)}\\
Métrica: \underline{4.99} (RMSE)\\
Semilla(s) / aleatoriedad: \underline{\textbf{61}} \\ \\
